        ...
        <div className="relative overflow-hidden bg-blue-600 rounded-[2.5rem] p-6 md:p-22 text-center shadow-2xl shadow-blue-200">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button
                className="text-xl px-8 lg:px-10 py-5 hover:scale-105 rounded-2xl border border-sky-700 bg-white text-blue-600 relative overflow-hidden group z-10 hover:text-white duration-1000"
                >
                <span
