        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <Link aria-label='tiktok link' target="_blank" href="https://www.tiktok.com/@kpsla8?_r=1&_t=ZN-94J3VXzMibm" className="h-10 w-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                <FaTiktok size={18} />
              </Link>
              <Link aria-label='facebook link' target="_blank" href="https://www.facebook.com/p/Kp-Students-Leadership-Association-61567282782387/" className="h-10 w-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                <FaFacebook size={18} />
              </Link>
              <Link aria-label='instagram link' target="_blank" href="https://www.instagram.com/kp_stdsleadershipassociation/?__d=1%2B" className="h-10 w-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                <FaInstagram size={18} />
              </Link>
            </div>
          </div>
