      ...
      <div className=" flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden rounded-full bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-blue-700 hover:shadow-lg active:scale-95 sm:block">
              Become a Member
            </button>
